"""
Django settings for popfm project.
...
SECRET_KEY = '4l6)v2*-0izgh(kfpfqr-sjncvywmnd5*k2($4w4sdaux4^-gu'
...
ROOT_URLCONF = 'popfm.urls'

WSGI_APPLICATION = 'popfm.wsgi.application'
